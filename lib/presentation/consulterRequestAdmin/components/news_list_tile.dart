...
import 'package:sopraflutter/presentation/consulterRequestAdmin/screens/details_screen.dart';
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        DateFormat('dd/MM/yyyy').format(widget.data.dateDebut.add(const Duration(days: 1))),
